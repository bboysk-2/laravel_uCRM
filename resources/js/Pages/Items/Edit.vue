...
//値を編集するにあたってリアクティブなオブジェクトにする必要があるため、変数に代入
                               ...
                               <div class="flex flex-wrap -m-2">
                                 ...
                                 <div class="p-2 w-full">
                                   <div class="relative">
                                     ...
                                     <div v-if="props.errors.memo" class="text-red-500">{{ props.errors.memo }}</div>
                                   </div>
                                 </div>
