...
/* harmony import */ var laravel_vite_plugin_inertia_helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! laravel-vite-plugin/inertia-helpers */ "./node_modules/laravel-vite-plugin/inertia-helpers/index.js");
...
(0,_inertiajs_inertia_vue3__WEBPACK_IMPORTED_MODULE_2__.createInertiaApp)({
  ...
  resolve: function resolve(name) {
    return (0,laravel_vite_plugin_inertia_helpers__WEBPACK_IMPORTED_MODULE_3__.resolvePageComponent)("./Pages/".concat(name, ".vue"), ({}).glob("./Pages/**/*.vue"));
  },
  setup: function setup(_ref) {
    ...
    }).use(plugin).use(_vendor_tightenco_ziggy_dist_vue_m__WEBPACK_IMPORTED_MODULE_4__.ZiggyVue, Ziggy).mount(el);
  },
  progress: {
    color: "#4B5563"
  }
...
var f = String.prototype.replace,
  ...
  S = function t(r, n, e, o, i, u, f, a, c, l, s, v, p, y) {
    ...
    for (var C = 0; C < k.length; ++C) {
      ...
      if (!i || null !== D) {
        var F = m(h) ? "function" == typeof e ? e(n, N) : n : n + (c ? "." + N : "[" + N + "]");
        w(x, t(D, F, e, o, i, u, f, a, c, l, s, v, p, y));
      }
    }
    return x;
  },
    ...
    for (var e = "string" == typeof t ? function (t, r) {
        ...
        for (n = 0; n < o.length; ++n) if (n !== i) {
          var f,
            ...
            l = c.indexOf("]="),
            s = -1 === l ? c.indexOf("=") : l + 1;
          -1 === s ? (f = r.decoder(c, T.decoder, u, "key"), a = r.strictNullHandling ? null : "") : (f = r.decoder(c.slice(0, s), T.decoder, u, "key"), a = d.maybeMap(N(c.slice(s + 1), r), function (t) {
            return r.decoder(t, T.decoder, u, "value");
          })), a && r.interpretNumericEntities && "iso-8859-1" === u && (a = C(a)), c.indexOf("[]=") > -1 && (a = x(a) ? [a] : a), e[f] = k.call(e, f) ? d.combine(e[f], a) : a;
        }
        return e;
    ...
    return n.matchesUrl = function (t) {
      ...
      return n.length ? this.template.replace(/{([^}?]+)(\??)}/g, function (e, o, i) {
        ...
        if (r.wheres[o]) {
          ...
          if (n[n.length - 1].name === o) return encodeURIComponent(null != (a = t[o]) ? a : "").replace(/%2F/g, "/");
        }
